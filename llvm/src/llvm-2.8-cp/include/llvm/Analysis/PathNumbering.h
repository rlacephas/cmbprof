...
#ifndef BALL_LARUS_PATH_NUMBERING_H
#define BALL_LARUS_PATH_NUMBERING_H
...
namespace llvm {
  ...
  class BallLarusDag {
    public:
      ...
      // Get the first edge on the path
      // PB: taken from llvm-cprof
      BallLarusEdge* getFirstBLEdge(unsigned int pathNumber);
