...
namespace llvm {
  ...
  extern const PassInfo *PathProfileLoaderPassID;
  ...
  //===--------------------------------------------------------------------===//
  //
  // createGenerateEdgeDominancePass - This pass creates a file containing
  // edge dominance for use by statistical edge profiling
  //
  ModulePass *createGenerateEdgeDominancePass();

  //===--------------------------------------------------------------------===//
  //
  // createGenerateEdgeNumberCFGsPass - This pass creates a set of CFGs for
  // each function which contain the edge numbers used in profiling.
  //
  ModulePass *createGenerateEdgeNumberCFGsPass();
