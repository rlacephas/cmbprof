...
namespace llvm {
  ...
  static inline void createFDIPreOptPasses(PassManagerBase *PM);
  static inline void createFDIPostOptPasses(PassManagerBase *PM);
  ...
  static inline void createStandardFunctionPasses(PassManagerBase *PM,
    ...
    errs() << "\n\nRefusing to create standard function passes\n\n";
    if(false)
    {
  ...
  static inline void createStandardModulePasses(PassManagerBase *PM,
    ...
    errs() << "\n\nRefusing to create standard module passes\n\n";
    if(false)
    {
  ...
  static inline void createStandardLTOPasses(PassManagerBase *PM,
    ...
    errs() << "\n\nRefusing to create standard link-time passes\n\n";
    if(false)
    {
  ...
  // copy and prune from standard passes above...
  static inline void createFDIFunctionPasses(PassManagerBase *PM) 
  {
    PM->add(createCFGSimplificationPass());
    PM->add(createScalarReplAggregatesPass());
    PM->add(createInstructionCombiningPass());
  ...
  static inline void createFDIPreOptPasses(PassManagerBase *PM)
  {
    // This is where we would do early-inlining
    ...
    //PM->add(createMemCpyOptPass());             // Remove memcpy / form memset
    PM->add(createSCCPPass());                  // Constant prop with SCCP
    PM->add(createInstructionCombiningPass()); // Run instcomb after
                                               // redundancy elim. to
                                               // exploit
